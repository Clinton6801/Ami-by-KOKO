...
export default function CreateChildModal({ parentId, onCreated }: CreateChildModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-amber-400 to-orange-400 px-6 pt-6 pb-8 text-center">
