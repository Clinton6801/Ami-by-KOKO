  ...
  return (
    <>
      <main className="flex min-h-screen flex-col items-center gap-6 px-4 py-10">
        ...
        {!hasPaid && isStudent && (
          <p className="text-amber-600 text-xs font-semibold">🔒 Some pads are locked</p>
        )}
        <MixingBoard hasPaid={hasPaid} onLockedTap={() => setUpgradeOpen(true)} isStudent={isStudent} />
      </main>
