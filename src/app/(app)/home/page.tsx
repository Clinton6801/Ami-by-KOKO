...
const MODES = [
  { href: "/phonics",  emoji: "🔤", title: "Phonics",    description: "Learn letters with Kòkò",    gradient: "from-amber-400 to-orange-400", shadow: "shadow-amber-200", ring: "ring-amber-200" },
  { href: "/dj-booth", emoji: "🎵", title: "DJ Booth",   description: "Mix sounds and make music",   gradient: "from-green-500 to-emerald-400", shadow: "shadow-green-200", ring: "ring-green-200" },
    ...
    <>
      <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 pb-10">
              ...
              <AnimatePresence>
                {showSwitcher && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -8 }}
                    className="absolute top-16 left-6 z-20 bg-white rounded-2xl shadow-xl ring-1 ring-amber-100 py-2 min-w-[160px]"
                  >
                    {children.map(c => (
                      <button key={c.id}
                    ...
                    <div className="border-t border-stone-100 mt-1 pt-1">
                      <button
                        onClick={() => { setShowModal(true); setShowSwitcher(false); }}
        ...
        <div className="px-4 mt-8">
          <h2 className="text-lg font-bold text-stone-700 mb-4">What do you want to do today?</h2>
