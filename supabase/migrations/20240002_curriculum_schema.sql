-- ============================================================
-- Àmì by Kòkò — Migration 002 (safe re-run version)
-- Only adds what's missing. Safe to run even if partially done.
-- ============================================================
...
-- Generate codes for schools that don't have one yet
update public.schools
set school_code = 'AMIK-' || lpad(floor(random() * 9999 + 1)::text, 4, '0')
where school_code is null;

-- Auto-generate school code on new school creation
